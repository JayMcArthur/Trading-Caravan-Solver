...
class MerchOptions(IntEnum):
    No_Merchant = 0       # Didn't buy or hasn't happened
    Cornucopia = 1        # Food consumption -2
    Route_to_Mahaji = 2   # Spice sell +20
    Wooden_Statuette = 3  # Gain a Statue (+500 points per Trader and Camel)
    Canvas_Bag = 4        # Carry Weight +20
    Leaders_Necklace = 5  # Gain one Trader
    Hand_of_Midas = 6     # When you sell everything -> Gold +100
    Sturdy_Saddle = 7     # Camels weight +20
    Magic_Cleppsydra = 8  # Max Day +1
    Blue_Treasure = 9     # Interest Rate +20%
...
class WitchOptions(IntEnum):
    No_Witch = 0            # Witch hasn't happened yet
    Presents_Gift = 1       # Carry Weight +20        -- Interest Rate -20%
    Vertue_of_Patience = 2  # Interest Rate is stable -- Jewelry cost +100
    Midas_was_a_Trader = 3  # Trader income +150      -- Marble sell *0
    Camelization = 4        # Camel weight +10        -- Camel eat 2x
    Time_is_Money = 5       # Max Day +1              -- Jewelry sell -500
    Animal_Lover = 6        # Gain two Camels         -- Max Day -1
    Oasis_of_Sanctifan = 7  # Crew don't eat          -- Silk buy +200
    The_Stonecutter = 8     # Marble weight -15       -- Marble cost +60
